...
if __name__ == '__main__':
    ...
    with open("resultats.csv" , "w+") as results:
        results.write(",heur_naive,heur_naive_bis,heur_naive_triee_selon_poids,heur_naive_triee_selon_poids_depl_obj,heur_naive_triee_selon_poids_depl_obj_bis,heur_naive_triee_selon_poids_depl_obj_ter,heur_naive_triee_selon_poids_depl_obj_quad\n")
        ...
        results.write("Moyenne,=MOYENNE(B2:B97),=MOYENNE(C2:C97),=MOYENNE(D2:D97),=MOYENNE(E2:E97),=MOYENNE(F2:F97),=MOYENNE(G2:G97),=MOYENNE(H2:H97)")
