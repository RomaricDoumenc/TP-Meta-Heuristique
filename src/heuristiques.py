...
#===============================================================================
# def heur_first_fit(listeObj , capBoites):
#     """Heuristique utilisant la méthode du first-fit : on trie loe objets par poids décroissant , puis on les range dans
#     l'ordre de la liste. Chaque objet traité est rangé"""
#     listeBoites = []
#     listeObj2 = listeObj.copy() # Copie de la liste d'objets afin de ne pas altérer la liste originale
#     i = 0 # itérateur pour l'id des boites
#     listeObj2 = trier_objets_selon_poids(listeObj2)
